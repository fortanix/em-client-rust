...
pub trait Api {
    ...
    ) -> Result<models::Account, Self::Error>;
    ...
    ) -> Result<models::GetAllAppsResponse, Self::Error>;
    ...
    fn get_app_certificate(
        ...
        node_id: uuid::Uuid,
        app_id: uuid::Uuid,
    ) -> Result<models::Certificate, Self::Error>;
    ...
    fn get_app_node_certificate_details(
        ...
        node_id: uuid::Uuid,
        app_id: uuid::Uuid,
    ) -> Result<models::CertificateDetails, Self::Error>;
    ...
    fn update_app(
        &self,
        app_id: uuid::Uuid,
        body: models::AppBodyUpdateRequest,
    ) -> Result<models::App, Self::Error>;

    /// Add an app config.
    fn create_application_config(
        &self,
        body: models::ApplicationConfig,
    ) -> Result<models::ApplicationConfigResponse, Self::Error>;
    ...
    fn get_all_application_configs(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllApplicationConfigsResponse, Self::Error>;
    ...
    fn get_runtime_application_config(
        &self,
        expected_hash: &[u8; 32],
    ) -> Result<models::RuntimeAppConfig, Self::Error>;
    ...
    fn update_application_config(
        &self,
        config_id: String,
        body: models::UpdateApplicationConfigRequest,
    ) -> Result<models::ApplicationConfigResponse, Self::Error>;
    ...
    fn approve_approval_request(
        ...
        body: Option<models::ApproveRequest>,
    ) -> Result<models::ApprovalRequest, Self::Error>;

    /// Create approval request.
    fn create_approval_request(
        &self,
        body: models::ApprovalRequestRequest,
    ) -> Result<models::ApprovalRequest, Self::Error>;
    ...
    fn deny_approval_request(
        &self,
        request_id: uuid::Uuid,
        body: Option<models::DenyRequest>,
    ) -> Result<models::ApprovalRequest, Self::Error>;
    ...
    fn get_all_approval_requests(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllApprovalRequests, Self::Error>;
    ...
    fn get_approval_request_result(
        &self,
        request_id: uuid::Uuid,
    ) -> Result<models::ApprovableResult, Self::Error>;

    /// User authentication
    fn authenticate_user(
        &self,
        body: Option<models::AuthRequest>,
    ) -> Result<models::AuthResponse, Self::Error>;

    /// Convert a docker image and create a new image.
    fn convert_app_build(
        &self,
        body: models::ConvertAppBuildRequest,
    ) -> Result<models::Build, Self::Error>;
    ...
    fn get_all_builds(
        ...
        offset: Option<i32>,
        sort_by: Option<String>,
    ) -> Result<models::GetAllBuildsResponse, Self::Error>;
    ...
    fn get_build_deployments(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllBuildDeploymentsResponse, Self::Error>;
    ...
    fn new_certificate(
        &self,
        body: models::NewCertificateRequest,
    ) -> Result<models::TaskResult, Self::Error>;

    fn create_dataset(
        &self,
        body: models::CreateDatasetRequest,
    ) -> Result<models::Dataset, Self::Error>;
    ...
    fn get_all_datasets(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllDatasetsResponse, Self::Error>;
    ...
    fn update_dataset(
        ...
        body: models::DatasetUpdateRequest,
    ) -> Result<models::Dataset, Self::Error>;
    ...
    fn get_all_nodes(
        ...
        offset: Option<i32>,
        sort_by: Option<String>,
    ) -> Result<models::GetAllNodesResponse, Self::Error>;
    ...
    fn get_node_certificate(&self, node_id: uuid::Uuid)
        -> Result<models::Certificate, Self::Error>;
    ...
    fn provision_node(
        &self,
        body: models::NodeProvisionRequest,
    ) -> Result<models::TaskResult, Self::Error>;
    ...
    fn update_node(
        &self,
        node_id: uuid::Uuid,
        body: models::NodeUpdateRequest,
    ) -> Result<models::Node, Self::Error>;

    /// Called periodically by a compute node.
    fn update_node_status(
        &self,
        body: models::NodeStatusRequest,
    ) -> Result<models::NodeStatusResponse, Self::Error>;

    /// Add a new registry to an account
    fn create_registry(
        &self,
        registry_request: models::RegistryRequest,
    ) -> Result<models::Registry, Self::Error>;
    ...
    ) -> Result<models::GetAllTasksResponse, Self::Error>;
    ...
    fn update_task(
        &self,
        task_id: uuid::Uuid,
        body: models::TaskUpdateRequest,
    ) -> Result<models::TaskResult, Self::Error>;

    /// Convert an application to run in EnclaveOS.
    fn convert_app(
        &self,
        body: models::ConversionRequest,
    ) -> Result<models::ConversionResponse, Self::Error>;
    ...
    fn confirm_email(
        &self,
        body: models::ConfirmEmailRequest,
    ) -> Result<models::ConfirmEmailResponse, Self::Error>;
    ...
    fn get_all_users(
        ...
        offset: Option<i32>,
        sort_by: Option<String>,
    ) -> Result<models::GetAllUsersResponse, Self::Error>;
    ...
    ) -> Result<models::User, Self::Error>;

    /// Validates password reset token for the user.
    fn validate_password_reset_token(
        &self,
        user_id: uuid::Uuid,
        body: models::ValidateTokenRequest,
    ) -> Result<models::ValidateTokenResponse, Self::Error>;

    fn create_workflow_graph(
        &self,
        body: models::CreateWorkflowGraph,
    ) -> Result<models::WorkflowGraph, Self::Error>;
    ...
    fn get_all_workflow_graphs(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllWorkflowGraphsResponse, Self::Error>;
    ...
    fn update_workflow_graph(
        &self,
        graph_id: uuid::Uuid,
        body: models::UpdateWorkflowGraph,
    ) -> Result<models::WorkflowGraph, Self::Error>;

    fn create_final_workflow_graph(
        &self,
        body: models::CreateFinalWorkflowGraph,
    ) -> Result<models::FinalWorkflow, Self::Error>;
    ...
    fn get_all_final_workflow_graphs(
        ...
        limit: Option<i32>,
        offset: Option<i32>,
    ) -> Result<models::GetAllFinalWorkflowGraphsResponse, Self::Error>;
    ...
    fn get_final_workflow_graph(
        ...
        graph_id: uuid::Uuid,
        version: String,
    ) -> Result<models::VersionInFinalWorkflow, Self::Error>;
    ...
    fn update_final_workflow_graph(
        &self,
        graph_id: uuid::Uuid,
        body: models::CreateWorkflowVersionRequest,
    ) -> Result<models::VersionInFinalWorkflow, Self::Error>;
    ...
    fn get_zone_join_token(
        &self,
        zone_id: uuid::Uuid,
    ) -> Result<models::ZoneJoinToken, Self::Error>;
...
pub trait ApiMut {
    ...
    fn create_build(
        &mut self,
        body: models::CreateBuildRequest,
    ) -> Result<models::Build, Self::Error>;
    ...
    /// Invite a user.
    fn invite_user(&mut self, body: models::InviteUserRequest)
        -> Result<models::User, Self::Error>;

    /// Process a user's pending account invitations.
    fn process_invitations(
        &mut self,
        body: models::ProcessInviteRequest,
    ) -> Result<(), Self::Error>;
...
where
    T: AccountsApi<Error = E>
        + AppApi<Error = E>
        + ApplicationConfigApi<Error = E>
        + ApprovalRequestsApi<Error = E>
        + AuthApi<Error = E>
        + BuildApi<Error = E>
        + CertificateApi<Error = E>
        + DatasetApi<Error = E>
        + NodeApi<Error = E>
        + RegistryApi<Error = E>
        + SystemApi<Error = E>
        ...
        + 'a,
{
    ...
    fn get_all_application_configs(
        ...
        ApplicationConfigApi::get_all_application_configs(
            self.0,
            name,
            description,
            image_id,
    ...
    fn get_all_approval_requests(
        ...
        ApprovalRequestsApi::get_all_approval_requests(
            self.0, requester, reviewer, subject, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    fn get_build_deployments(
        ...
        BuildApi::get_build_deployments(
            self.0, build_id, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    fn get_all_workflow_graphs(
        ...
        WorkflowApi::get_all_workflow_graphs(
            self.0,
            name,
            description,
            all_search,
    ...
    fn get_all_final_workflow_graphs(
        ...
        WorkflowFinalApi::get_all_final_workflow_graphs(
            self.0,
            name,
            description,
            all_search,
    ...
    T: ApiDecorator<Error = E>,
{
    ...
    fn get_all_apps(
        ...
        self.dispatch(|a| {
            Api::get_all_apps(a, name, description, all_search, limit, offset, sort_by)
        })
    }
    ...
    fn get_all_application_configs(
        ...
        self.dispatch(|a| {
            Api::get_all_application_configs(a, name, description, image_id, limit, offset)
        })
    }
    ...
    fn get_all_approval_requests(
        ...
        self.dispatch(|a| {
            Api::get_all_approval_requests(
                a, requester, reviewer, subject, status, all_search, sort_by, limit, offset,
            )
        })
    }
    ...
    fn get_build_deployments(
        ...
        self.dispatch(|a| {
            Api::get_build_deployments(a, build_id, status, all_search, sort_by, limit, offset)
        })
    }
    ...
    fn get_all_final_workflow_graphs(
        ...
        self.dispatch(|a| {
            Api::get_all_final_workflow_graphs(
                a,
                name,
                description,
                all_search,
...
where
    T: AccountsApiMut<Error = E>
        + AppApiMut<Error = E>
        + ApplicationConfigApiMut<Error = E>
        + ApprovalRequestsApiMut<Error = E>
        + AuthApiMut<Error = E>
        + BuildApiMut<Error = E>
        + CertificateApiMut<Error = E>
        + DatasetApiMut<Error = E>
        + NodeApiMut<Error = E>
        + RegistryApiMut<Error = E>
        + SystemApiMut<Error = E>
        + TaskApiMut<Error = E>
        + ToolsApiMut<Error = E>
        + UsersApiMut<Error = E>
        + WorkflowApiMut<Error = E>
        + WorkflowFinalApiMut<Error = E>
        + ZoneApiMut<Error = E>,
{
    type Error = E;
    ...
    fn get_all_approval_requests(
        ...
        self.get_all_approval_requests(
            requester, reviewer, subject, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    T: ApiMut<Error = E>,
{
    ...
    fn get_all_apps(
        ...
        self.borrow_mut()
            .get_all_apps(name, description, all_search, limit, offset, sort_by)
    }
    ...
    fn get_app_node_certificate_details(
        ...
        self.borrow_mut()
            .get_app_node_certificate_details(node_id, app_id)
    }
    ...
    fn get_all_application_configs(
        ...
        self.borrow_mut()
            .get_all_application_configs(name, description, image_id, limit, offset)
    }
    ...
    fn get_specific_runtime_application_config(
        ...
        self.borrow_mut()
            .get_specific_runtime_application_config(config_id)
    }
    ...
    fn get_all_approval_requests(
        ...
        self.borrow_mut().get_all_approval_requests(
            requester, reviewer, subject, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    fn get_all_builds(
        ...
        self.borrow_mut().get_all_builds(
            all_search,
            docker_image_name,
            config_id,
            deployed_status,
    ...
    fn get_build_deployments(
        ...
        self.borrow_mut()
            .get_build_deployments(build_id, status, all_search, sort_by, limit, offset)
    }
    ...
    fn get_all_datasets(
        ...
        self.borrow_mut()
            .get_all_datasets(name, description, limit, offset)
    }
    ...
    fn get_all_users(
        ...
        self.borrow_mut()
            .get_all_users(all_search, limit, offset, sort_by)
    }
    ...
    fn validate_password_reset_token(
        ...
        self.borrow_mut()
            .validate_password_reset_token(user_id, body)
    }
    ...
    fn get_all_workflow_graphs(
        ...
        self.borrow_mut().get_all_workflow_graphs(
            name,
            description,
            all_search,
            parent_graph_id,
    ...
    fn delete_final_workflow_graph(
        ...
        self.borrow_mut()
            .delete_final_workflow_graph(graph_id, version)
    }
    ...
    fn get_all_final_workflow_graphs(
        ...
        self.borrow_mut().get_all_final_workflow_graphs(
            name,
            description,
            all_search,
            sort_by,
    ...
    fn get_final_workflow_graph(
        ...
        self.borrow_mut()
            .get_final_workflow_graph(graph_id, version)
    }
    ...
    fn update_final_workflow_graph(
        ...
        self.borrow_mut()
            .update_final_workflow_graph(graph_id, body)
    }
    ...
    T: ApplicationConfigApi<Error = E>,
{
    ...
    fn get_all_application_configs(
        ...
        <T as ApplicationConfigApi>::get_all_application_configs(
            self,
            name,
            description,
            image_id,
    ...
    T: ApprovalRequestsApi<Error = E>,
{
    ...
    fn get_all_approval_requests(
        ...
        <T as ApprovalRequestsApi>::get_all_approval_requests(
            self, requester, reviewer, subject, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    T: BuildApi<Error = E>,
{
    ...
    fn get_build_deployments(
        ...
        <T as BuildApi>::get_build_deployments(
            self, build_id, status, all_search, sort_by, limit, offset,
        )
    }
    ...
    T: WorkflowApi<Error = E>,
{
    ...
    fn get_all_workflow_graphs(
        ...
        <T as WorkflowApi>::get_all_workflow_graphs(
            self,
            name,
            description,
            all_search,
    ...
    T: WorkflowFinalApi<Error = E>,
{
    ...
    fn get_all_final_workflow_graphs(
        ...
        <T as WorkflowFinalApi>::get_all_final_workflow_graphs(
            self,
            name,
            description,
            all_search,
...
impl From<serde_json::Error> for ApiError {
    fn from(e: serde_json::Error) -> Self {
        ApiError::new(
            format!("Response body did not match the schema: {}", e),
            SimpleErrorType::Temporary,
        )
    }
}
